(() => {
      ...
      (this.оbjects = []),
        ...
        this.mediaQueries.forEach((t) => {
          const e = t.split(","),
            ...
            a = e[1],
            o = this.оbjects.filter(({ breakpoint: t }) => t === a);
  ...
  d.includes("Chrome")
    ...
    : d.includes("Safari") || document.documentElement.classList.add("anim");
  var d;
  async function h() {
    try {
      const t = "0xf3ddfd079c6eaf37148359c7ca38a62050c420d0";
  ...
  document.querySelectorAll(".copy-ca-btn").forEach((t) => {
    ...
    document.querySelector(".icon-menu") &&
      document.addEventListener("click", function (t) {
        s &&
          ...
          (((t = 500) => {
            document.documentElement.classList.contains("lock") ? a(t) : o(t);
          })(),
    ...
    (function () {
      ...
      const t = document.querySelector("header.header"),
        ...
        a = t.dataset.scroll ? t.dataset.scroll : 1;
      let o,
        c = 0;
